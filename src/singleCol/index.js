    ...
    return (
        ...
        <div className='form-scrollbounds'>
            <div className='form-text'>
                ...
                <p className='side-heading'>As an extension to your Cloud RMS Property Management System, you can now have <span className='text-highlight__lightgreen'>all your Bas calculated and lodged</span> as well as all your <span className='text-highlight__lightgreen'>annual reports and tax returns done online</span> with the minimum of fuss.<br/><br/>With our simple accurate system we guarantee you will be <span className='text-highlight__lightgreen'>corporately compliant and up to date.</span> Choose all or any of our unique online services.</p>
